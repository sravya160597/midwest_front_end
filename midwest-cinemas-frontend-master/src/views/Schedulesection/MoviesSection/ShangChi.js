...
const movieScheduleData = {
  moviename: "Shang-Chi and the Legend of the Ten Rings(U/A) ",
  Director: "Destin Daniel Cretton ",
  Starring: "Awkwafina,Simu Liu,Michelle Yeoh,Tim Roth ",
  synopisis:"Shang-Chi, the master of unarmed weaponry-based Kung Fu, is forced to confront his past after being drawn into the Ten Rings organization.", 
  movieTheatorList: [
    {
