...
const movieScheduleData = {
  moviename: "Dhuandhaar(U/A)  ",
  Director: "Rehan Chaudhary  ",
  Starring: "Malhar Thakar Malhar Thakar, Hiten Kumar, Netri Trivedi, Dimple Biscuitwala and Alisha Prajapati ",
  synopisis:"Don`t Breath 2 is the sequel to the 2016 movie Don`t Breathe. This one is set in the years following the initial deadly home invasion, where Norman Nordstrom (Stephen Lang) lives in quiet solace until his past sins catch up to him.  ",
  movieTheatorList: [
    {
