...
const movieScheduleData = {
  moviename: "Varudu Kaavalenu(U/A)  ",
  Director: "Lakshmi Sowjanya  ",
  Starring:
    "Naga Shaurya, Ritu Varma, Murali Sharma, Nadiya, Vennela Kishore, Praveen, Harsha Vardhan  ",
  synopisis:
    "Bhoomi doesn't believe in love and Akash is on a journey to find love. What happens when they meet?  ",
  movieTheatorList: [
    {
