...
const movieScheduleData = {
  moviename: "HONSLA RAKH (PUNJABI)(U/A)  ",
  Director: "N/A  ",
  Starring: "Diljit Dosanjh, Sonam Bajwa, Shehnaaz Gill, Shinda Grewal,  ",
  synopisis:
    "upcoming Indian Punjabi-language romantic comedy film directed by Amarjit Singh Saron starring Diljit Dosanjh, Sonam Bajwa, Shehnaaz Gill and Shinda Grewal, It marks the debut of Diljit Dosanjh as producer.  ",
  movieTheatorList: [
    {
