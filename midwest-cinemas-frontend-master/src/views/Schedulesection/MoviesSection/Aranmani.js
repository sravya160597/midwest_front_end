...
const movieScheduleData = {
  moviename: "Aranmanai 3(U/A)  ",
  Director: "Sundar C  ",
  Starring:
    "Arya, Sundar C, Raashi Khanna, Andrea, Shakshi Agarwall, Vivek, Yogi Babu, Manobala  ",
  synopisis:
    "An evil spirit is haunting an old house and its inhabitants have to go to great lengths to get rid of it. This is the third movie in the Aranmanai film series.  ",
  movieTheatorList: [
    {
