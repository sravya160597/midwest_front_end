...
const movieScheduleData = {
  moviename: "Bell Bottom(U/A)",
  Director: "Ranjit Tiwari  ",
  Starring: "Vaani Kapoor, Akshay Kumar, Lara Dutta  ",
  synopisis:
    "Get ready to go back to the 80s and hop onto a roller-coaster spy ride,BELLBOTTOM  ",
  movieTheatorList: [
    {
